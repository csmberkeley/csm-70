...
We can now find the $99\%$ confidence interval as $|\frac{X - \E[X]}{\sqrt{\text{Var}[X]}}| = \Phi^{-1} (0.995) = 2.576$. 
We solve this to find $x = \E[X] \pm \Phi^{-1}(0.995)\sqrt{\text{Var}[X]} = 3.5 \pm 2.576\sqrt{\frac{35}{12n}}$
\end{solution}

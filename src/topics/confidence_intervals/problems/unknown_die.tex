...
\item Develop a 99\% confidence interval for the value of n samples assuming $n$ is large enough. 
\begin{solution}[3cm]
...
\item Now, we say the die's values are consecutive integers, but we do no۪t know where it starts. It is shifted over by some value $k$; for example, if $k = 6$, the die faces would take on the values 
$7, 8, 9, 10, 11, 12$. If we observe that the average of the $n$ 
samples is 15.5, develop a 99\% confidence 
interval for the value of $k$ assuming $n$ is large enough. 
